			...
			$('.poster_list_add').on('click', function(e) {
				...
				var addStaffText = '<li class="clearfix li_active">' + 
										'<div class="business_poster_area clearfix">' +
											...
											'<input type="text" class="form-control business_poster_title" id="business_posters_title" />' +
											...
											'<div class="business_poster_text_area add_form fr">' +
												'<textarea name="business_poster_text_title_outline_c1" class="business_poster_text"></textarea>' +
											'</div>' +
										'</div>' +
