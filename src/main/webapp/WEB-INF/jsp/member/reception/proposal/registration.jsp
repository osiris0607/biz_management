		...
		if ( status != 'D0000001') {
			...
			if ( $("#selector_company").is(":checked") ) {
				var chkVal = ["reg_no", "company_name", "company_address", "company_phone", "representative_name", "industry_type", "business_type", 
					  		  ...
					  		  "sevice_name", "sevice_description", "tech_info_feature", "tech_info_area"];
			} else {
							...
							<tbody>
								<tr id="target_tr">
									...
									<td>
										...
										<input type="radio" id="selector_member" name="selector_class" value="개인" >
					    ...
					    <table class="write fixed company_d">
							...
							<tbody>
								<tr id="research_name_tr">
								    ...
								    <td>
								    	<input type="text" id="research_name" title="연구책임자 성명" class="form-control w_20" placeholder="" />
							    	</td> 
							    </tr>
							    ...
							    <tr id="email_tr">
								    ...
								    <td>
									    <input type="text" name="email_1" id="email_1" title="연구책임자 메일" class="form-control w_20 fl ls" placeholder="" />
									    <span class="fl ml1 mr1 pt10 mail_f">@</span>
									    <label for="email_2" class="hidden">이메일</label>
									    <input type="text" name="email_2" id="email_2" title="연구책임자 메일" class="form-control w_18 fl ls" placeholder="" disabled  />	
							    ...
							    <tr id="research_address_tr">
									...
									<td>
										<input disabled type="text" id="research_address" title="연구책임자 주소" class="form-control w50 fl  mr5" placeholder="" />
										<input disabled type="text" id="research_address_detail" title="연구책임자 주소" class="form-control w30 fl mr5" placeholder="" />
