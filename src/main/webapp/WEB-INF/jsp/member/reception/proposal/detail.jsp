					...
					<div class="content_area member_area not_view_reception" id="member_area">	
						...
						<div class="not_view_reception">			
							...
							<table class="write fixed">
								...
								<label for="submit_files_name_7" class="hidden">파일찾기</label>
								<label for="submit_files_name_8" class="hidden">파일찾기</label>
								<label for="submit_files_name_9" class="hidden">파일찾기</label>
								<label for="submit_files_name_10" class="hidden">파일찾기</label>
								</tbody>						 
							</table>									
							<!--//기술컨설팅 -제출서류 -->
						</div>>
