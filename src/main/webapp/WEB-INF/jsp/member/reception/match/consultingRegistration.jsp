...
<script type='text/javascript'>
	...
	function prepareRegistration(status) {
		...
		if ( $("input:radio[name=con_radio_check]").is(":checked") == false ) {
								...
								<tbody>
									<tr>
										...
										<td>
											...
											<label for="direct_companypart_phone2" class="hidden">전화</label>
											...
											<label for="direct_companypart_phone3" class="hidden">전화</label>
