...
/* 		$("#custom_expert_list_body input[type='checkbox']:checked").each(function() {
	    	...
	    	expert.institution_name = $row.find('td:eq(3) input').val();
	    	expert.institution_department = $row.find('td:eq(4) input').val();
		...
		formData.append("self_check_list_json", JSON.stringify(selfCheckList));
	 	 ...
	 	 $.ajax({
		    type : "POST",
		    url : "/member/api/reception/match/modification",
		    data : formData,
		    processData: false,
		    contentType: false,
		    ...
		    success : function(data) {
		        ...
		        if (jsonData.result == 1) {
		        	showPopup("수정 완료되었습니다.", "접수 안내");
		        	isModification = true;
		        } else {
		        	showPopup("수정에 실패하였습니다. 다시 시도해 주시기 바랍니다.", "접수 안내");
		        }
		    },
		    error : function(err) {
		        alert(err.status);
				...
				<div class="content_area copmpany_area" id="copmpany_area" >													
					<div class="table_area">
					    ...
					    <table class="write fixed company_d">
							...
							<tbody>
							    ...
							    <tr id="email_tr">
								    ...
								    <td>
									    <input type="text" name="email_1" id="email_1" title="이메일" class="form-control w_20 fl ls" />
									    <span class="fl ml1 mr1 pt10 mail_f">@</span>
									    <label for="email_2" class="hidden">이메일</label>
									    <input type="text" name="email_2" id="email_2" title="이메일" class="form-control w_18 fl ls" disabled  />	
						...
						<table class="write fixed research_tabel_">
							...
							<tbody>
								...
								<tr id="sevice_content_tr">
								   	<th scope="row">
								   		<span class="icon_box"><span class="necessary_icon">*</span>
								   		<label for="sevice_content">기술연구개발 내용</label></span>
							   		</th>
							    	<td>
							    		<input type="text" id="sevice_content" class="form-control w100" title="기술연구개발 내용" placeholder="기업이 개발하고자 하는 기술 내용 입력" />
						    		</td>
							    </tr>										
						...
						<div class="button_box clearfix fr pb20">
							...
							<button type="button" class="blue_btn2 fl mr5" onclick="prepareModification('D0000003');">임시저장</button>
							<button type="button" class="blue_btn fl mr5" onclick="prepareModification('D0000004');">전문가신청완료</button>
...
<div class="reception_complete_popup_box">		
	...
	<div class="reception_complete_popup">
		...
		<div class="popup_txt_area">
		    ...
		    <div class="popup_button_area_center">
				<button type="submit" class="blue_btn mr5" onclick="modification('D0000004');">예</button>
...
<div class="temp_save_box" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 10000; display: none;">
	...
	<div class="save_popup2_popup">
		...
		<div class="popup_txt_area">						
		    ...
		    <div class="popup_button_area_center">
				<button type="button" class="blue_btn mr5" onclick="modification('D0000003');">저장</button>
