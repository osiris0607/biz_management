...
<script type='text/javascript'>
	...
	function prepareRegistration(status) {
		console.log('reg status :: ', status);  //D0000004
		...
		if ( status != "D0000003" ) {
			var chkVal = ["reg_no", "company_name", "company_address", "company_phone", "representative_name", "industry_type", "business_type", 
				  ...
				  "research_name",
				  //"mobile_phone_2", "mobile_phone_3", "email_1", "email_2",
				  //"research_address", "research_address_detail", 
			...
			if ( $("input:radio[name=consulting_take_yn_radio]").is(":checked") == false && $("#consulting_purpose_tr").attr("use_yn") != "n" ) {
				showPopup("사전 컨설팅 실시 여부 은(는) 필수입력입니다.", "접수 안내");
				return;
			}
	...
	function registration(status){
		...
		$.each(mChoiceExpertList, function(key, value) {
			console.log('mChoiceExpertList ---> ', key, value);
		...
		$.each(mDirectChoiceExpertList, function(key, value) {
			console.log('mDirectChoiceExpertList ---> ', key, value);
			var expert = new Object();
			expert.member_id = "";
	...
	function addChoicedExpert(){
		...
		var addStaffText = '<tr>' +
		'<td class="first"><input type="checkbox">&nbsp;<label for="">&nbsp;</label></td>'+
				...
				<div class="content_area copmpany_area" id="copmpany_area" >													
					<div class="table_area">
					    ...
					    <table class="write fixed">
						   ...
						   <tbody>
							    <tr id="consulting_type_tr" use_yn="n">
						...
						<table class="write fixed research_tabel_">
							...
							<tbody>
								...
								<tr id="sevice_request_tr">
								    ...
								    <td>
								    	<input type="text" id="tech_info_market_report" class="form-control w100" title="시장/기술 동향" placeholder="기술의 시장성 및 기술 동향 입력" />
							    	</td> 										    
								</tr>	
								<tr id="sevice_content_tr">
							    	...
							    	<td>
							    		<input type="text" id="reception_rnd_text" class="form-control w100" title="기술연구개발 내용" placeholder="기업이 개발하고자 하는 기술 내용 입력" />
						    		</td>
							    </tr>										
