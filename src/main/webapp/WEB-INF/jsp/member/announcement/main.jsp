	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				...
				str += "	<td><a href='/member/fwd/announcement/detail?announcement_id=" + value.announcement_id + "'><div class='txt_hidden'>" + value.title + "</div></a></td>";
					...
					<div class="search_area">
						<dl class="search_box">
							...
							<dd class="box">
								...
								<select name="list-search-member-class" id="type_selector" class="in_wp250 fl ace-select" title="사업명">
						  	 ...
						  	 <div class="input_search_box fl in_w64_2">
								<label for="search_text" class="hidden">검색어 입력</label>
								<input id="search_text" class="in_w80 fl ml10" name="input_txt" type="text" placeholder="키워드를 입력하여 공고를 검색하실 수 있습니다." />
