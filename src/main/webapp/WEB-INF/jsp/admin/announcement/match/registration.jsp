...
<script type='text/javascript'>
	...
	$(document).ready(function() {
		nhn.husky.EZCreator.createInIFrame({
	 	...
	 	$("input:radio[name=technology_class]").change(function(){
			// 기술매칭 (기술 컨셀팅)과 기술매칭 (기술 연구개발)의 입력 항목이 다르다.		
			if ($("input:radio[name=technology_class]:checked").val() == "D0000001"){
				//기술 컨설팅 요청사항
				$("#technique_consulting_name_5").text("컨설팅 목적");
				// 기술 정보
				$("#technology_name_1").text("제품/서비스명");
				$("#technology_name_2").text("제품/서비스 내용");
				$("#technology_name_3").text("기술애로사항");
				$("#technology_name_4").text("컨설팅 요청사항");
				$("#technology_name_5").text("첨부 파일");
				$("#technology_tr_6").hide();
				$("#technology_tr_6").attr("use_yn", "N");
				//제출 서류
				$("#doc_ext_name_1").text("기술컨설팅 신청서");
				$("#doc_ext_name_2").text("캠퍼스타운 기술매칭 확인서");
				$("#doc_ext_name_3").text("특허");
				$("#doc_ext_name_4").text("기술설계서");
				$("#doc_ext_name_5").text("사업자등록증");
				$("#doc_ext_name_6").text("기타");
				$("#doc_ext_tr_7").hide();
				$("#doc_ext_tr_7").attr("use_yn", "N");
			}
			else {
				//기술 컨설팅 요청사항
				$("#technique_consulting_name_5").text("사전 컨설팅 실시 여부");
				// 기술 정보
				$("#technology_name_1").text("제품/서비스명");
				$("#technology_name_2").text("제품/서비스 내용");
				$("#technology_name_3").text("시장/기술 동향");
				$("#technology_name_4").text("기술연구개발 내용");
				$("#technology_name_5").text("기술연구개발 범위");
				$("#technology_tr_6").show();
				$("#technology_tr_6").attr("use_yn", "Y");
				//제출 서류
				$("#doc_ext_name_1").text("기술연구개발 신청서");
				$("#doc_ext_name_2").text("기술개선/기술융합:TRL 6단계 증명서류 / 창업아이디어: TRL 3단계 증명서류");
				$("#doc_ext_name_3").text("캠퍼스타운 기술연구개발 확인서(캠타기업은 필수)");
				$("#doc_ext_name_4").text("사업자등록증");
				$("#doc_ext_name_5").text("재무제표(최근 3년 이내)");
				$("#doc_ext_name_6").text("특허");
				$("#doc_ext_tr_7").show();
				$("#doc_ext_tr_7").attr("use_yn", "Y");
			}
	 	});
	...
	function prepareRegistration(status) {
		...
		//다음화면으로 넘어가기위해 [다음]버튼에 tab_2 클래스 추가
		$("#nextBtn").addClass("tab_2");
		console.log('add class?', $("#nextBtn").hasClass("tab_2"));
		if($("#nextBtn").hasClass("tab_2") == true) {
	...
	function checkStatus(status) {
		var temp = $("#process_status").val(status);
		// 임시 저장 Popup 실행
		if (status == "D0000001") {
	...
	function registration(status){
		...
		formData.append("type", $("input:radio[name=technology_class]:checked").val());
		...
		for (var i=0; i<$("#document_body tr").length; i++ ) {
			...
			if ( gfn_isNull($("#doc_ext_name_"+ (i+1)).text()) == false)
			{
				var tempInfo = new Object();
		...
		$.ajax({
		    type : "POST",
		    url : "/admin/api/announcement/match/registration",
		    data : formData,
		    processData: false,
		    contentType: false,
						   ...
						   <div class="announcement_tab1">
							   ...
							   <table class="list2">
								   ...
								   <colgroup>
   								   ...
   								   <thead>
									   <tr>
										   <th scope="row"><span class="icon_box"><span class="necessary_icon">*</span><label for="announcement_title">구분</label></span></th>
										   <td>
										       <input type="radio" name="technology_class" id="technology_class1" value="D0000001" checked>
										       <label for="technology_class1" class="mr10">기술매칭(기술 컨설팅)</label>
                                               <input type="radio" name="technology_class" id="technology_class2" value="D0000002">
                                               <label for="technology_class2" >기술매칭(기술 연구개발)</label>
										   </td>
									   </tr>
								   </thead>
								   <tbody>
							   ...
							   <div class="fr mt30 clearfix">
								   <button type="button" id="nextBtn" class="fl blue_btn mr5" onclick="prepareRegistration('D1111111');">다음</button>							   
							   </div>
					       </div><!--//공고정보-->
						   <!--다음버튼 눌렀을때 기관정보-->
						   <div class="announcement_tab2" style="display:none;">
							   ...
							   <table class="list2 technology_information tbody_t">
								   ...
								   <tbody id="technique_consulting_body">
								       <tr>
										   <th scope="row" id="technique_consulting_name_1">구분</th>
										   <td>									   
											   <input type="radio" id="con_radio_select13" class="checkbox_reception_selected" value='D0000001' name="con_reception_technique_radiooptions1" checked="checked" />
											   <label for="con_radio_select13" class="mr10">선택</label>
											   <input type="radio" id="con_radio_select13_2_" class="checkbox_reception_notselected" value='D0000002' name="con_reception_technique_radiooptions1" />
											   <label for="con_radio_select13_2_" class="mr10">선택 안함</label>	   						   
										   </td>
									   </tr>
									   <tr>
										   <th scope="row" id="technique_consulting_name_2">소속 캠퍼스타운</th>
										   <td>									   
											   <input type="radio" id="con_radio_select14" class="checkbox_reception_selected" value='D0000001' name="con_reception_technique_radiooptions2" checked="checked" />
											   <label for="con_radio_select14" class="mr10">선택</label>
											   <input type="radio" id="con_radio_select14_2_" class="checkbox_reception_notselected" value='D0000002' name="con_reception_technique_radiooptions2" />
											   <label for="con_radio_select14_2_" class="mr10">선택 안함</label>	   						   
										   </td> 
									   </tr>
									   <tr>
										   <th scope="row" id="technique_consulting_name_3">국가기술분류체계</th>
										   <td>
											   <input type="radio" id="con_radio_select15" class="checkbox_reception_selected" value='D0000001' name="con_reception_technique_radiooptions3" checked="checked" />
											   <label for="con_radio_select15" class="mr10">선택</label>
											   <input type="radio" id="con_radio_select15_2_" class="checkbox_reception_notselected" value='D0000002' name="con_reception_technique_radiooptions3" />
											   <label for="con_radio_select15_2_" class="mr10">선택 안함</label>	   	
											</td> 
									   </tr>
									   <tr>
										   <th scope="row" id="technique_consulting_name_4">4차 산업혁명 기술분류</th>
										   <td>
											   <input type="radio" id="con_radio_select16" class="checkbox_reception_selected" value='D0000001' name="con_reception_technique_radiooptions4" checked="checked" />
											   <label for="con_radio_select16" class="mr10">선택</label>
											   <input type="radio" id="con_radio_select16_2" class="checkbox_reception_notselected" value='D0000002' name="con_reception_technique_radiooptions4" />
											   <label  for="con_radio_select16_2" class="mr10">선택 안함</label>	   	
											</td> 
									   </tr>
									   <tr>
										   <th scope="row" id="technique_consulting_name_5">컨설팅 목적</th>
										   <td>
											   <input type="radio" id="con_radio_select17" class="checkbox_reception_selected" value='D0000001' name="con_reception_technique_radiooptions5" checked="checked" />
											   <label for="con_radio_select17" class="mr10">선택</label>
											   <input type="radio" id="con_radio_select17_2" class="checkbox_reception_notselected" value='D0000002' name="con_reception_technique_radiooptions5" />
											   <label for="con_radio_select17_2" class="mr10">선택 안함</label>	   	
											</td> 
									   </tr>									   
								   </tbody>
							   </table>	 
							   ...
							   <table class="list2 technology_information tbody_t">
								   ...
								   <tbody id="technology_body">
								       <tr>
										   <th scope="row" id="technology_name_1">제품/서비스명</th>
										   <td>									   
									   ...
									   <tr>
										   <th scope="row" id="technology_name_2">제품/서비스 내용</th>
										   <td>									   
									   ...
									   <tr>
										   <th scope="row" id="technology_name_3">기술애로사항</th>
										   <td>
									   ...
									   <tr>
										   <th scope="row" id="technology_name_4">컨설팅 요청사항</th>
										   <td>
									   ...
									   <tr>
										   <th scope="row" id="technology_name_5">연구 분야</th>
										   <td>
   									   ...
   									   <tr id="technology_tr_6">
										   <th scope="row" id="technology_name_6">첨부파일</th>
										   <td>
											   <input type="radio" id="radio_select18" class="checkbox_reception_selected" name="reception_technique_radiooptions6" value="D0000001" checked="checked" />
											   <label for="radio_select18" class="mr10">선택</label>
											   <input type="radio" id="radio_select18_2" class="checkbox_reception_notselected" name="reception_technique_radiooptions6" value="D0000002"/>
											   <label for="radio_select18_2" class="mr10">선택 안함</label>	   	
											</td> 
									   </tr>
								   </tbody>
							   </table>							   
							   ...
							   <div style="overflow-x:auto;">						       
								   <table class="list submission">
									   ...
									   <tbody id="document_body">
										   <tr>
											   <td>1</td>
											   <td><span id="doc_ext_name_1">기술컨설팅 신청서</span></td>
											   <td>PDF</td>
										   ...
										   <tr>
											   <td>2</td>
											   <td><span id="doc_ext_name_2">캠퍼스타운 기술매칭 확인서</span></td>
											   <td>PDF</td>
										   ...
										   <tr>
											   <td>3</td>
											   <td><span id="doc_ext_name_3">특허</span></td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" name="reception_document_radiooptions3" value="D0000003"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" name="reception_document_radiooptions3" value="D0000001" checked />
											   <label class="w_0">&nbsp;</label></td>
										   ...
										   <tr>
											   <td>4</td>
											   <td><span id="doc_ext_name_4">기술설계서</span></td>
											   <td>PDF</td>
										   ...
										   <tr>
											   <td>5</td>
											   <td><span id="doc_ext_name_5">사업자등록증</span></td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" name="reception_document_radiooptions5" value="D0000003"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" name="reception_document_radiooptions5" value="D0000001" checked />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" name="reception_document_radiooptions5" value="D0000002"/>
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>6</td>
											   <td><span id="doc_ext_name_6">기타</span></td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" name="reception_document_radiooptions6" value="D0000003"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" name="reception_document_radiooptions6" value="D0000001" checked />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" name="reception_document_radiooptions6" value="D0000002"/>
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr id="doc_ext_tr_7">
											   <td>7</td>
											   <td><span id="doc_ext_name_7">논문</span></td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" name="reception_document_radiooptions7" value="D0000003"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" name="reception_document_radiooptions7" value="D0000001" checked />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" name="reception_document_radiooptions7" value="D0000002" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
									   </tbody>
								   </table>
							   ...
							   <div class="fr mt30">
								   <button type="button" class="blue_btn2" onclick="checkStatus('D0000001');">임시 저장</button>
								   <button type="button" class="blue_btn" onclick="checkStatus('D0000002');">등록</button>
