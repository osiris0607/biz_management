...
<script type='text/javascript'>
		...
		if ( data.result.ext_field_list != null) {
			...
			for(var i=0; i<ext_field_list.length; i++) {
				if ( ext_field_list[i].ext_type == "D0000008") {
					str += "<tr>";
					str += "	<th scope='row' id='target_info_" + (i+1) + "' extension_id='" + ext_field_list[i].extension_id + "'>" + ext_field_list[i].ext_field_name + "</th>";
					str += "	<td>";
					// '개인'인 경우
					if ( ext_field_list[i].ext_field_yn == "D0000001"){
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_selected' value='D0000001' name='target_radiooptions_" + (i+1) + "' checked />";
						str += "		<label for='target_radio_select" + (i+1) + "' style='margin-right:13px;font-size:15px'>개인</label>";
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_notselected' value='D0000002' name='target_radiooptions_" + (i+1) + "' />";
						str += "		<label class='mr10' for=member_'radio_select" + (i+1) + "'>기관</label>";
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_notselected' value='D0000003' name='target_radiooptions_" + (i+1) + "' />";
						str += "		<label class='mr10' for=member_'radio_select" + (i+1) + "'>개인/기관</label>";
					}
					else if ( ext_field_list[i].ext_field_yn == "D0000002") { // '기관'인 경우
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_selected' value='D0000001' name='target_radiooptions_" + (i+1) + "'  />";
						str += "		<label for='target_radio_select" + (i+1) + "' style='margin-right:13px;font-size:15px'>개인</label>";
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_notselected' value='D0000002' name='target_radiooptions_" + (i+1) + "' checked />";
						str += "		<label class='mr10' for=member_'radio_select" + (i+1) + "'>기관</label>";
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_notselected' value='D0000003' name='target_radiooptions_" + (i+1) + "' />";
						str += "		<label class='mr10' for=member_'radio_select" + (i+1) + "'>개인/기관</label>";
					}
						...
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_notselected' value='D0000002' name='target_radiooptions_" + (i+1) + "'  />";
						str += "		<label class='mr10' for=member_'radio_select" + (i+1) + "'>기관</label>";
						str += "		<input type='radio' id='target_radio_select" + (i+1) + "' class='checkbox_reception_notselected' value='D0000003' name='target_radiooptions_" + (i+1) + "' checked />";
						str += "		<label class='mr10' for=member_'radio_select" + (i+1) + "'>개인/기관</label>";
					}
					str += "	</td>";
					str += "</tr>";
			...
			$("#target_body").append(str);	
	    }
		

		// 개인 정보
	   	$("#personal_info_body").empty();
	    if ( data.result.ext_field_list != null) {
			var ext_field_list = data.result.ext_field_list;
			var str = "";
			for(var i=0; i<ext_field_list.length; i++) {
				if ( ext_field_list[i].ext_type == "D0000007") {
					str += "<tr>";
					str += "	<th scope='row' id='personal_info_" + (i+1) + "' extension_id='" + ext_field_list[i].extension_id + "'>" + ext_field_list[i].ext_field_name + "</th>";
					str += "	<td>";
					// '선택'인 경우
					if ( ext_field_list[i].ext_field_yn == "D0000001"){
						str += "		<input type='radio' id='member_radio_select" + (i+1) + "' class='checkbox_reception_selected' value='D0000001' name='reception_member_radiooptions" + (i+1) + "' checked />";
						str += "		<label for='member_radio_select" + (i+1) + "' style='margin-right:13px;font-size:15px'>선택</label>";
						str += "		<input type='radio' id='member_radio_select" + (i+1) + "_1' class='checkbox_reception_notselected' value='D0000002' name='reception_member_radiooptions" + (i+1) + "' />";
						str += "		<label class='mr10' for=member_'radio_select" + (i+1) + "_1'>선택 안함</label>";
					}
					else { // '선택 안함'인 경우
						str += "		<input type='radio' id='member_radio_select" + (i+1) + "' class='checkbox_reception_selected' value='D0000001' name='reception_member_radiooptions" + (i+1) + "' />";
						str += "		<label for='member_radio_select" + (i+1) + "' style='margin-right:13px;font-size:15px'>선택</label>";
						str += "		<input type='radio' id='member_radio_select" + (i+1) + "_1' class='checkbox_reception_notselected' value='D0000002' name='reception_member_radiooptions" + (i+1) + "'  checked />";
						str += "		<label class='mr10' for='member_radio_select" + (i+1) + "_1'>선택 안함</label>";
					}
					str += "	</td>";
					str += "</tr>";
				}
			}
			$("#personal_info_body").append(str);
	    }
	    ...
	    if ( data.result.ext_field_list != null) {
			...
			for(var i=0; i<ext_field_list.length; i++) {
				if ( ext_field_list[i].ext_type == "D0000001") {
					str += "<tr>";
					str += "	<th scope='row' id='institutions_name_" + index + "' extension_id='" + ext_field_list[i].extension_id + "'>" + ext_field_list[i].ext_field_name + "</th>";
					str += "	<td>";
					// '선택'인 경우
					if ( ext_field_list[i].ext_field_yn == "D0000001"){
						str += "		<input type='radio' id='radio_select" + index + "' class='checkbox_reception_selected' value='D0000001' name='reception_institutions_radiooptions" + index + "' checked />";
						str += "		<label for='radio_select" + index + "' style='margin-right:13px;font-size:15px'>선택</label>";
						str += "		<input type='radio' id='radio_select" + index + "_1' class='checkbox_reception_notselected' value='D0000002' name='reception_institutions_radiooptions" + index + "' />";
						str += "		<label class='mr10' for='radio_select" + index + "_1'>선택 안함</label>";
					}
					else { // '선택 안함'인 경우
						str += "		<input type='radio' id='radio_select" + index + "' class='checkbox_reception_selected' value='D0000001' name='reception_institutions_radiooptions" + index + "' />";
						str += "		<label for='radio_select" + index + "' style='margin-right:13px;font-size:15px'>선택</label>";
						str += "		<input type='radio' id='radio_select" + index + "_1' class='checkbox_reception_notselected' value='D0000002' name='reception_institutions_radiooptions" + index + "'  checked />";
						str += "		<label class='mr10' for='radio_select" + index + "_1'>선택 안함</label>";
					}
					str += "	</td>";
					str += "</tr>";
	...
	function modification(status) {
		...
		for (var i=0; i<$("#target_body tr").length; i++ ) {
			...
			tempInfo.extension_id = $("#target_info_"+ (i+1)).attr("extension_id");
			tempInfo.ext_type = "D0000008";
			tempInfo.ext_field_yn = $("input:radio[name=target_radiooptions_" + (i+1) + "]:checked").val();
			tempInfo.ext_field_name = $("#target_info_"+ (i+1)).text() ;
		...
		for (var i=0; i<$("#personal_info_body tr").length; i++ ) {
			var tempInfo = new Object();
			tempInfo.announcement_id = $("#announcement_id").val();
			tempInfo.extension_id = $("#personal_info_"+ (i+1)).attr("extension_id");
			tempInfo.ext_type = "D0000007";
			tempInfo.ext_field_yn = $("input:radio[name=reception_member_radiooptions" + (i+1) + "]:checked").val();
			tempInfo.ext_field_name = $("#personal_info_"+ (i+1)).text() ;
			extList.push(tempInfo);
		}
		
		// 기관 정보
		var temp = $("#agency_information_body tr").length;
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/announcement/proposal/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
                       ...
                       <div class="contents_view">
						   ...
						   <div class="announcement_tab2">
							   ...
							   <!--//체크리스트-->
								   ...
								   <button type="button" class="gray_btn2 fl" onclick="location.href='/admin/fwd/announcement/proposal/main'">목록</button>
						   		</div>
						   </div><!--contents_view-->
						   </div><!--//다음버튼 눌렀을때 기관정보-->	
					   </div><!--//contents view-->
		   ...
		   <div class="announcement_write_popup">
			   ...
			   <div class="popup_txt_area">
				   ...
				   <div class="popup_button_area_center clearfix mt10">
					   <button type="button" class="blue_btn mr5">예</button>
