...
<script type='text/javascript'>
	...
	function registration(status){
		...
		// 접수 대상
		for (var i=0; i<$("#target_body tr").length; i++ ) {
			var targetInfo = new Object();
			targetInfo.ext_type = "D0000008";
			targetInfo.ext_field_yn = $("input:radio[name=target_radiooptions_" + (i+1) + "]:checked").val();
			targetInfo.ext_field_name = $("#target_info_"+ (i+1)).text() ;
			extList.push(targetInfo);
		}
		...
		$.ajax({
		    type : "POST",
		    url : "/admin/api/announcement/proposal/registration",
		    data : formData,
		    processData: false,
		    contentType: false,
                       ...
                       <div class="location_area">
					       <div class="location_division">
					           ...
					           <ul class="location clearfix">
								   ...
								   <li>공고관리</li>
								   <li><strong>기술제안</strong></li>
							   </ul>	
							  <!--//페이지 경로-->
							  <!--페이지타이틀-->
							   <h3 class="title_area">기술제안</h3>
							  <!--//페이지타이틀-->
						    </div>
					   </div>
                       ...
                       <div class="contents_view">
						   ...
						   <div class="announcement_tab2" style="display:none;">
						       ...
						       <div class="view_top_area clearfix mt30">
								   <h4 class="fl sub_title_h4">접수 대상</h4>								   
							   </div>
							   <table class="list2 agency_information tbody_t">
								   ...
								   <tbody id="target_body">
									   <tr>
										   <th scope="row" id="target_info_1">접수대상</th>
										   <td>
											   <input type="radio" id="target_radio_select1" class="checkbox_reception_selected" value='D0000001' name="target_radiooptions_1" checked="checked" />
											   <label for="target_radio_select1" style="margin-right:13px;font-size:15px">개인</label>
											   <input type="radio" id="target_radio_select1" class="checkbox_reception_notselected" value='D0000002' name="target_radiooptions_1" />
											   <label class="mr10" for="target_radio_select1">기관</label>
											   <input type="radio" id="target_radio_select1" class="checkbox_reception_notselected" value='D0000003' name="target_radiooptions_1" />
											   <label class="mr10" for="target_radio_select1">개인/기관</label>
										   </td> 
									   </tr>							   
								   </tbody>
							   </table>	
							   ...
							   <table class="list2 technology_information tbody_t">
								   ...
								   <tbody id="technology_body">
									   ...
									   <tr>
										   <th scope="row" id="technology_name_2">기술개요</th>
										   <td>									   
									   ...
									   <tr>
										   <th scope="row" id="technology_name_3">실증분야</th>
										   <td>
									   ...
									   <tr>
										   <th scope="row" id="technology_name_4">국가과학기술분류</th>
										   <td>
									   ...
									   <tr>
										   <th scope="row" id="technology_name_5">4차 산업혁명 기술분류</th>
										   <td>
											   <input type="radio" id="radio_select17" class="checkbox_reception_selected" name="reception_technique_radiooptions5" value="D0000001" checked="checked" /><label for="radio_select17" class="mr10">선택</label>
									   ...
									   <tr>
										   <th scope="row" id="technology_name_6">기술 특징</th>
										   <td>
											   <input type="radio" id="radio_select18" class="checkbox_reception_selected" name="reception_technique_radiooptions6" value="D0000001" checked="checked" /><label for="radio_select18" class="mr10">선택</label>
									   ...
									   <tr>
										   <th scope="row" id="technology_name_7">적용 분야</th>
										   <td>
											   <input type="radio" id="radio_select19" class="checkbox_reception_selected" name="reception_technique_radiooptions7" value="D0000001" checked="checked" /><label for="radio_select19" class="mr10">선택</label>
											   <input type="radio" id="radio_select19_2" class="checkbox_reception_notselected" name="reception_technique_radiooptions7" value="D0000002"/>
											   <label for="radio_select19_2" class="mr10">선택 안함</label>	   	
											</td> 
									   </tr>
								   </tbody>
							   </table>							   
							   ...
							   <div style="overflow-x:auto;">						       
								   <table class="list submission">
									   ...
									   <tbody id="document_body">
										   <tr>
											   <td>1</td>
											   <td id="doc_ext_name_1">기술제안서</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions1" checked="checked" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions1" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions1" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>2</td>
											   <td id="doc_ext_name_2">기술 등록 및 활용 동의서</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions2" checked="checked" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions2" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions2" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>3</td>
											   <td id="doc_ext_name_3">R&D 참여 현황 및 사업비 사용계획</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions3" checked="checked" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions3" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions3" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>4</td>
											   <td id="doc_ext_name_4">특허(출원, 등록) 증빙자료</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions4" checked="checked" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions4" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions4" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>5</td>
											   <td id="doc_ext_name_5">사업자등록증, 법인등기부등본, 최근 2년간 표준재무제표증명원 각 1부</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions5" checked="checked" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions5" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions5" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>6</td>
											   <td id="doc_ext_name_6">TRL 6단계 이상 증빙자료</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions6" checked="checked" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions6" />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions6" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										    <tr>
											   <td>7</td>
											   <td id="doc_ext_name_7">서울시산학연협력사업 최근 3년 이내 ‘우수‘ 최종평가 증빙</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions7"  />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions7" checked="checked"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions7" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>8</td>
											   <td id="doc_ext_name_8">여성기업인 확인서</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions8"  />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions8" checked="checked"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions8" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>9</td>
											   <td id="doc_ext_name_9">장애인기업 확인서</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions9"  />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions9" checked="checked"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions9" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
										   <tr>
											   <td>10</td>
											   <td id="doc_ext_name_10">사회적기업 확인서</td>
											   <td>PDF</td>
											   <td><input type="radio" class="checkbox_reception_selected" value="D0000003" name="reception_document_radiooptions10"  />
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000001" name="reception_document_radiooptions10" checked="checked"/>
											   <label class="w_0">&nbsp;</label></td>
											   <td><input type="radio" class="checkbox_reception_notselected" value="D0000002" name="reception_document_radiooptions10" />
											   <label class="w_0">&nbsp;</label></td>
										   </tr>
									   </tbody>
								   </table>
							   ...
							   <div class="fr mt30">
								   ...
								   <button type="button" class="gray_btn2" onclick="location.href='/admin/fwd/announcement/proposal/main'">목록</button>
							   </div>
						   </div><!--contents_view-->
						   </div><!--//다음버튼 눌렀을때 기관정보-->	
					   </div><!--//contents view-->
