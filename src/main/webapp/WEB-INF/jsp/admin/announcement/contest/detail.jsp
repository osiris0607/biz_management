...
<script type='text/javascript'>
	...
	function withdrawal() {
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/announcement/contest/withdrawal",
	...
	function moveModification(){
		location.href = "/admin/fwd/announcement/contest/modification?announcement_id=" + $("#announcement_id").val();
	}
	...
	<table class="table_view">
	   ...
	   <tbody>
		   ...
		   <div class="fr mt30 clearfix">
		   	   <button type="button" class="gray_btn2 fl mr5" onclick="location.href='/admin/fwd/announcement/contest/main'">목록</button>
