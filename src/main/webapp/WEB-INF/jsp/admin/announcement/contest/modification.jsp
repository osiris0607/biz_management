...
<script type='text/javascript'>
	...
	function getDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/announcement/contest/detail'/>");
	...
	function modification(status) {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/announcement/contest/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
                   ...
                   <div class="contents">
                       ...
                       <div class="contents_view">
						   ...
						   <div class="fr mt30 clearfix">
							   ...
							   <button type="button" class="gray_btn2 fl" onclick="location.href='/admin/fwd/announcement/contest/main'">목록</button>
						   </div>
						   </div><!--//다음버튼 눌렀을때 기관정보-->	
					   </div><!--//contents view-->
