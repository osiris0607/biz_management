...
<script type='text/javascript'>
	$(document).ready(function() {
		...
		searchMemberDetail(mReceptionDetail.member_id);
		makeDisplay();
	});
	...
	function makeDisplay() {
		// 개인정보
		$("#member_id").html("<span>" + mMemberDetail.member_id + "</span>");
		$("#member_name").html("<span>" + mMemberDetail.name + "</span>");
		$("#member_mobile_phone").html("<span>" + mMemberDetail.mobile_phone + "</span>");
		$("#member_email").html("<span>" + mMemberDetail.email + "</span>");
		$("#member_address").html("<span>" + mMemberDetail.address + " " + mMemberDetail.address_detail + "</span>");
	...
	function receptionComplete() {
		...
		$.ajax({
		    ...
		    success : function(data) {
		    	...
		    	location.href='/admin/fwd/reception/proposal/main';
		    },
		    error : function(err) {
		        alert(err.status);
		    }
				    ...
				    <div class="contents_view">
	                   ...
	                   <table class="list2 write fixed">
							...
							<thead>
								<tr>
									<th scope="row">
										<span class="icon_box"><span class="necessary_icon">*</span>아이디</span></th>
									<td id="member_id"><span>abc123</span></td> 
								</tr>	
							</thead>
							<tbody>																	  
								<tr>
									<th scope="row">
										<span class="icon_box"><span class="necessary_icon">*</span>성명</span>
									</th>
									<td id="member_name"><span>홍길동</span></td> 
								</tr>
								<tr>
									<th scope="row">
										<span class="icon_box"><span class="necessary_icon">*</span>휴대전화</span>
									</th>
									<td id="member_mobile_phone"><span>02-2222-1234</span></td> 
								</tr>
								<tr>
									<th scope="row">
										<span class="icon_box"><span class="necessary_icon">*</span>이메일</span></th> 
									<td id="member_email"><span>abc@ino.com</span></td> 
								</tr>
								<tr>
									<th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>주소</span></th> 
									<td id="member_address"><span>경기도 성남시 수정구 00동 456-5</span></td> 
								</tr>									
							</tbody>
					   </table>
					   <!--//개인정보-->
					   ...
					   <!--기술 정보-->
                           ...
                           <table class="list2 font_white">
							   ...
							   <thead>
								   <tr>
									   <th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>기술명</span></th>
									   <td id="tech_info_name"><span></span></td> 
								   </tr>
							   </thead>
							   <tbody>
   								   <tr>
									   <th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>기술 개요</span></th>
									   <td id="tech_info_description"><span>기술개요</span></td> 
								   </tr>
								   <tr>
										<th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>실증 분야</span></th>
										<td id="tech_info_type"><span>예산지원형</span></td> 
									</tr>
								   <tr>
									   <th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>국가과학기술분류</span></th>
									   <td id="tech_info_science_type">
											<span class="fl mr5">대분류</span><span class="fl mr5">&gt;</span><span class="fl mr5">중분류</span><span class="fl mr5">&gt;</span><span class="fl">소분류</span>
										</td>
								   </tr>
								   <tr>
										<th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>4차 산업혁명 기술분류</span></th>
										<td id="tech_info_4th_industry"><span>5G</span></td> 
									</tr>
								   <tr>
									   <th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>기술 특징</span></th>
									   <td id="tech_info_feature"><span></span></td> 
								   </tr>
								   <tr>
										<th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>적용 분야</span></th>
										<td id="tech_info_area"><span>적용분야</span></td> 
									</tr>								   
							   </tbody>
						   </table>	
						   <!--//기술 정보-->
					  ...
					  <div class="view_top_area clearfix mt30">
					   ...
					   <div class="fr mt30">
						   ...
						   <button type="button" class="gray_btn2" onclick="location.href='/admin/fwd/reception/contest/main'">목록</button>
					   </div>
				   </div><!--contents_view-->
                </div>
			   <!--//contents--> 
