...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.addParam("announcement_type", "D0000004");
			...
			$.each(receptionList, function(key, value) {
				...
				if ( value.reception_status == "D0000002" || value.reception_status == "D0000011" || value.reception_status == "D0000012" ||
					...
					if (value.reception_status == "D0000002" ) {
						str += "	<td><a href='/admin/fwd/reception/proposal/detail?reception_id=" + value.reception_id + "&announcement_id=" + value.announcement_id + "'><span class='reception_waiting2'>접수신청</span></a></td>";
					}
					if (value.reception_status == "D0000011" ) {
						str += "	<td><a href='/admin/fwd/reception/proposal/detail?reception_id=" + value.reception_id + "&announcement_id=" + value.announcement_id + "'>접수취소</span></a></td>";
					}
					if (value.reception_status == "D0000012" ) {
						str += "	<td><a href='/admin/fwd/reception/proposal/detail?reception_id=" + value.reception_id + "&announcement_id=" + value.announcement_id + "'><span class='reception_completed2'>접수완료</span></a></td>";
					}
					if (value.reception_status == "D0000013" || value.reception_status == "D0000014") {
						str += "	<td><a href='/admin/fwd/reception/proposal/detail?reception_id=" + value.reception_id + "&announcement_id=" + value.announcement_id + "' class='reception_rejected_btn gray_btn2'>반려</a></td>";
					}
	...
	function downloadExcelFile() {
		if (confirm('다운로드하시겠습니까?')) {
			location.href = "/admin/api/reception/excelDownload?announcement_type=D0000004";
		}
	}
</script>
			   ...
			   <div class="lnb_menu_area">	
			       <ul class="lnb_menu">
					   ...
					   <li class="menu2depth">
							   ...
							   <li class="active"><a href="/admin/fwd/reception/proposal/main">기술제안</a></li>
					   		</ul>
					   </li>
				   </ul>				
			   </div>	
