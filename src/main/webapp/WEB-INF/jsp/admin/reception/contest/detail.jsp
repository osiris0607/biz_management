	...
	function receptionComplete() {
		...
		$.ajax({
		    ...
		    success : function(data) {
		    	...
		    	location.href='/admin/fwd/reception/contest/main';
		    },
		    error : function(err) {
		        alert(err.status);
		    }
					   ...
					   <!--기술 정보-->
                           ...
                           <table class="list2 font_white">
							   ...
							   <tbody>
								   ...
								   <tr>
									   <th scope="row"><span class="icon_box"><span class="necessary_icon">*</span>기대 효과</span></th>
									   <td id="tech_info_effect"><span></span></td> 
								   </tr>								   
							   </tbody>
						   </table>	
						   <!--//기술 정보-->
