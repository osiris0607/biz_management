...
<script type='text/javascript'>
	$(document).ready(function() {
		...
		searchReceptionDetail("D0000006");
		makeExpertList();
	});
	...
	function makeExpertList() {
		var body = $("#expert_result_body");
		var str = "";
		body.empty();
		// D0000007 - 전문가 선택 완료인 경우
		// D0000008 - 매칭 완료
		if ( mReceptionDetail.reception_status == "D0000007") {
			$("#match_expert").show();
			$("#match_result").show();
			$("#match_complete_btn").show();
			$("#match_complete").hide();
			...
			body.append(str);
		} else if ( mReceptionDetail.reception_status == "D0000008") {
			$("#match_expert").hide();
			$("#match_result").hide();
			$("#match_complete_btn").hide();
			$("#match_complete").show();
			   ...
			   <!--본문시작-->
           		<div class="contents">
				    ...
				    <div class="contents_view">
					   ...
					   <div id="match_expert">
						   <div class="view_top_area clearfix mt30">
							   <h4 class="fl sub_title_h4">참여 전문가</h4>							  
						   </div>
	                          <table class="list2 ta_c bd_r">
							   <caption>참여전문가</caption> 
							   <colgroup>
								   <col style="width: 5%" />
								   <col style="width: 23%" />
								   <col style="width: 10%" />
					  ...
					  <div id="match_result" style="display: none;">
						  <div class="view_top_area clearfix mt30">
							   <h4 class="fl sub_title_h4">전문가 매칭 결과</h4>							  
						   </div>
	                          <table class="list2 font_white ta_c">
							   <caption>전문가 매칭 결과</caption> 
							   <colgroup>
								   <col style="width: 10%" />
								   <col style="width: 20%" />
								   <col style="width: 10%" />
...
<div class="application_completed_popup_box">
   ...
   <div class="application_completed_popup">
	   ...
	   <div class="popup_txt_area">
		   <p>작성된 정보로 <span class="font_blue">매칭 완료</span> 하시겠습니까?</p>
		   <div class="popup_button_area_center">
			   <button type="button" class="blue_btn mr5" onclick="matchComplete();">예</button>
