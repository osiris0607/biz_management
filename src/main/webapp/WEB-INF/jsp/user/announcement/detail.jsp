...
<script type='text/javascript'>
	...
	function getDetail() {
		...
		comAjax.setUrl("<c:url value='/user/api/announcement/detail'/>");
		...
		<div id="sub_contents">
		    <div class="content_area">
				...
				<div class="content_area">
				   ...
				   <button type="button" class="gray_btn fr mt20 mr3 mb20" onclick="location.href='/user/fwd/announcement/main'">목록</button>
				</div><!--content_area-->
			</div>
		</div><!--sub_contents-->
	</section>
