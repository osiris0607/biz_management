	...
	<article class="contents">
		<div class="wrap_area clearfix">
			...
			<div class="sub_contents" id="sub_contents">
				...
				<div class="board_notice_area notice_view_area">
					<div class="list_table">
						<table class="list2 view_table notice_table_view">
						...
						<div class="write_button_area mt30">
							<button type="button" class="gray_btn2 fr" onclick="location.href='/userHome/fwd/announcement/notice/noticeMain'">목록</button>
						</div>
					</div>						
				</div>
			</div>
