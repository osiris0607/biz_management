<script type='text/javascript'>
	...
	*******************************************************************************/
	function btn_searchList_onclick(pageNo) {
		...
		comAjax.addParam("content_type", "P");
	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(g_searchList, function(key, value) {
				...
				str += "			<textarea name='business_poster_text_title_outline_c1' id='business_poster_text1' class='business_poster_text' disabled='disabled'>" + value.content_description + "</textarea>";
				str += "		</div>";
				str += "	</div>";
				str += "</li>";
	...
	<article class="sub_route">
		...
		<div class="wrap_area">
			<ul>
				...
				<li><a href="/userHome/fwd/business/proposal/summary">주요사업 안내</a></li>
				<li><a href="/userHome/fwd/business/proposal/summary">기술제안</a></li>
				<li><a href="/userHome/fwd/business/proposal/intro">사업소개</a></li>
			</ul>	
		</div>
	</article>
	<!-- //서브 경로 -->
	...
	<article class="contents">
		<div class="wrap_area clearfix">
			...
			<div class="lnb" id="lnb">							
				...
				<ul class="lnb_menu">
					<li class="on"><a href="/userHome/fwd/business/proposal/summary">기술제안</a>
						<ul>
							<li><a href="/userHome/fwd/business/proposal/summary">사업개요</a></li>
							<li class="on"><a href="/userHome/fwd/business/proposal/intro">수행사업소개</a></li>
						</ul>
					</li>
			...
			<div class="sub_contents" id="sub_contents">
				...
				<div class="proposition_intro_area intro_area">
