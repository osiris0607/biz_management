	...
	function searchListCB(data) {
		...
		else 
		{
			...
			$.each(g_searchList, function(key, value) {
				...
				str += "	<td class='announcement_name write_title'><a href='/adminHome/board/poster/detail?board_id=" + value.board_id +"'>" + value.title + "</a></td>";
			...
			<div class="table_count_area">
				<div class="count_area clearfix mb10">
					...
					<div class="fr clearfix">
						...
						<a href="/adminHome/board/poster/registration" class="blue_btn link_btn fl">등록</a>											
					</div>
				</div>
			</div>
