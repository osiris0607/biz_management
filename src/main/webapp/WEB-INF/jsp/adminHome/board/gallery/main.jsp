	...
	function searchListCB(data) {
		...
		else 
		{
			...
			$.each(g_searchList, function(key, value) {
				...
				str += "	<td class='bs_class'>" + value.business_name + "</span></td>";
				str += "	<td class='announcement_name write_title'><a href='/adminHome/board/gallery/detail?board_id=" + value.board_id +"'>" + value.title + "</a></td>";
				str += "	<td class='company_name'>" + value.institue_name + "</td>";
				str += "	<td class='date'>" + value.from_date + " ~ " + value.to_date + "</td>";
		...
		$.ajax({
		    ...
		    success : function(data) {
		        ...
		        if (jsonData.result == 1) {
			        ...
			        location.href = "/adminHome/board/gallery/main";
		        } else {
			...
			<div class="table_count_area">
				<div class="count_area clearfix mb10">
					...
					<div class="fr clearfix">
						...
						<a href="/adminHome/board/gallery/registration" class="blue_btn link_btn fl">등록</a>											
					</div>
				</div>
			</div>
